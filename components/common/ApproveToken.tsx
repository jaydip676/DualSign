...
import { createPublicClient, http, PublicClient, WalletClient, Hash, Address } from "viem";
...
export const approveToken = async (amount: bigint, tokenContractAddress: Address, address: Address): Promise<ApprovalResult> => {
...
const readAllowance = async (tokenContractAddress: Address, ownerAddress: Address): Promise<bigint> => {
